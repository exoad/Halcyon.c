#include "include/com_jackmeng_platform_sys_out.h"
...
JNIEXPORT void JNICALL Java_com_jackmeng_platform_sys_1out_f_1out(
  ...
  env->DeleteLocalRef(content_arr);
  env->DeleteLocalRef(str_file_ptr);
}