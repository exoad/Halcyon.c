...
import com.jackmeng.halcyon.core.util.use_Struct.struct_Trio;
...
public final class use_Color
{
  ...
  {
    return new Color(use_HalcyonCore.rng.nextInt(255), use_HalcyonCore.rng.nextInt(255),
        use_HalcyonCore.rng.nextInt(255));
  }
