...
public class use_Playlist implements Iterable<String>, impl_Identifiable {
  ...
  public use_Playlist(playlist_Traits traits, String parent, String[] endings) {
    this.parent = parent;
  ...
  public use_Playlist(playlist_Traits traits, String parent) {
    this(traits, parent, null);
  }

  protected use_Playlist(String name, String[] children, String[] endings, playlist_Traits traits) {
    this.parent = name;
  ...
  /**
   * @param name Absolute path of the children to find
  ...
  /**
   * @param e The name of the FOLDER construct
   * @return A {@link com.jackmeng.util.use_Playlist} object
   */
  public static use_Playlist construct(File e, String[] endings) {
    return new use_Playlist(e.getAbsolutePath(), e.list(new FilenameFilter() {
      @Override
