...
public abstract interface const_FetcherBuiltin
{
  ...
  String BUILTIN_LOCALE = "builtin" + use_HalcyonProperties.getFileSeparator();

  /*------------------------------------------------------ /
  / The following represents locations to default PLOOGINS /
  /-------------------------------------------------------*/
  String PLOOGINS = BUILTIN_LOCALE + "ploogins" + use_HalcyonProperties.getFileSeparator();
  String PLOOGIN_DEFAULT_LUA = PLOOGINS + "lua" + use_HalcyonProperties.getFileSeparator();
